"""
Parser for the SAG Award for Outstanding Performance by a Male Actor in a Supporting Role.
Source: wikipedia/Actor Award for Outstanding Performance by a Male Actor in a Supporting Role - Wikipedia.html
Output: data/sag_supporting_actor.csv with columns: year, actor, film, is_winner, is_tie
"""
...
HTML_FILE = Path(__file__).parent.parent / "wikipedia" / "Actor Award for Outstanding Performance by a Male Actor in a Supporting Role - Wikipedia.html"
OUTPUT_FILE = Path(__file__).parent.parent / "data" / "sag_supporting_actor.csv"
...
def clean(element):
    # Remove <small> annotations before extracting text
