"""
Parser for the SAG Award for Outstanding Performance by a Male Actor in a Leading Role.
Source: wikipedia/Actor Award for Outstanding Performance by a Male Actor in a Leading Role - Wikipedia.html
Output: data/sag_lead_actor.csv with columns: year, actor, film, is_winner, is_tie
"""
...
HTML_FILE = Path(__file__).parent.parent / "wikipedia" / "Actor Award for Outstanding Performance by a Male Actor in a Leading Role - Wikipedia.html"
OUTPUT_FILE = Path(__file__).parent.parent / "data" / "sag_lead_actor.csv"
    ...
    for table in tables:
        ...
        for row in table.find_all("tr"):
            ...
            records.append({
                ...
                "film": clean(film_td),
                "is_winner": "true" if is_winner_cell(actor_td) else "false",
                "is_tie": "false",
            })
